...
export default function SignupPage() {
  ...
  return (
    <div className={`relative min-h-screen ${pageBg} ${textPrimary} overflow-hidden flex items-center justify-center px-6 py-10 transition-colors duration-300`}>
      <div
      ...
      <div className={`relative z-10 w-full max-w-sm ${cardBg} border ${cardBorder} rounded-2xl p-8 shadow-2xl transition-colors duration-300`}>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          <div>
            <label className={`text-xs ${textMuted} mb-1 block`}>Full name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className={`text-xs ${textMuted} mb-1 block`}>Password</label>
            <input
              type="password"
              value={password}
          ...
          <div>
            <label className={`text-xs ${textMuted} mb-1 block`}>Confirm password</label>
            <input
              type="password"
